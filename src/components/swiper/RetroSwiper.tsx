...
import styles from "./styles/RetroSwiper.module.scss";
...
export default function RetroSwiper({ slides, arrowSrc }: RetroSwiperProps) {
  ...
  return (
    <div className={styles.retroSwiperRoot}>
      ...
      <div className={styles.slideCaption}>
        ...
        <p className={styles.slideCaptionText}>{t(slides[activeIdx]?.text)}</p>
      </div>
    </div>
  );
}
